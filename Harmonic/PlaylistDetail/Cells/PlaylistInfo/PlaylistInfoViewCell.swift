...
protocol PlaylistInfoViewCellDelegate: AnyObject {
    func didTapShareButton(button: UIButton)
}

class PlaylistInfoViewCell: UITableViewCell {
    static let identifier = "PlaylistInfoViewCell"
    ...
    weak var delegate: PlaylistInfoViewCellDelegate?
    ...
    public func configure(viewModel: PlaylistInfoCellViewModel) {
